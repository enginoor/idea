            ...
            Form {
                ...
                Section("Verification tool") {
                    ...
                    if AppState.toolIsReachable(appState.c2paToolPath) {
                        ...
                        Label("Tool not found. Install it with cargo install c2patool, or fix the path above.", systemImage: "exclamationmark.triangle")
                            .font(.caption)
                ...
                Section("About") {
                    ...
                    Text("OriginCheck answers one question: was this text or file generated by Claude?")
                        .font(.caption)
                        .foregroundStyle(.secondary)
                }
            }
